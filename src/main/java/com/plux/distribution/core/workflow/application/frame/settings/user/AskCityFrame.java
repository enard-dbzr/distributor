...
public class AskCityFrame extends AbstractFrame {

    private final UserBuilder userBuilder;

    private InteractionId lastMessageId = null;

    public AskCityFrame(UserBuilder userBuilder) {
    ...
    public static class AskCityFrameFactory extends PoolAwareSerializer<AskCityFrame> {

        @Override
        public PoolNodeSnapshotBuilder buildSnapshot(@NotNull FrameContext context, AskCityFrame instance,
        ...
        @Override
        public AskCityFrame create(@NotNull FrameContext context, PoolNodeSnapshot snapshot) {
            var instance = new AskCityFrame(
